...
learning_rate = float(0.0025) if args.learning_rate is None else int(args.learning_rate)
hidden_units = int(512) if args.hidden_units is None else float(args.hidden_units)
